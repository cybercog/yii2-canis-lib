function TealSelector(parent, options) {
   var self = this;
   this.parent = parent;
   var defaultOptions = {
   ...
   if (TealLister !== undefined && this.options.callback instanceof TealLister) {
...
TealSelector.prototype.resetSelector = function() {
...
TealSelector.prototype.hideSelector = function() {
   this.resetSelector();
   this.selectorElements.canvas.hide();
};

TealSelector.prototype.showSelector = function() {
   this.selectorElements.canvas.show();
};


(function ($) { 
   $.fn.tealSelector = function (options) {
         var $this = this;
         if ($this.tealSelectorObject === undefined) {
            $this.tealSelectorObject = new TealSelector($this, options);
         }
         return $this.tealSelectorObject;
   };
}(jQuery));