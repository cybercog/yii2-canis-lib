...
$.fn.canisAffix = function (options) {
	var $self = $(this);
	var $parent = $(this).parent().first();
	$(this).addClass('canis-affix');
	...
	var navOuterHeight = $(this).canisNavBarHeight();
...
/**
  ...
  */
function canisAnchorScrollFix(event, href) {
    href = typeof(href) == "string" ? href : $(this).attr("href");
    if(!href) return;
    var fromTop = $(this).canisNavBarHeight() + 10;
    var $target = $(href);
    if($target.length) {
...
// ajax form
$(document).on('submit.canis-api', 'form.ajax', function(e) {
	var options = {};
	if ($(this).data('data')) {
...
$(document).on('click.canis-api', '[data-handler="background"]', function (e) {
	var $this   = $(this), href;
