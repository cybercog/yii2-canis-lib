...
RestDraw.prototype.drawItems = function($itemContainer, items) {
	var self = this;
	$itemContainer.html('');
	var $itemList = $("<div />").addClass('canis-rest-draw-list list-group').appendTo($itemContainer);
...
RestDraw.prototype.drawItem = function($itemContainer, item) {
	var $itemObject = $("<a />", {'href': '#', 'class': 'canis-rest-draw-item list-group-item'}).appendTo($itemContainer);
