...
RestDraw.prototype.drawItems = function($itemContainer, items) {
	var self = this;
	$itemContainer.html('');
	var $itemList = $("<div />").addClass('infinite-rest-draw-list list-group').appendTo($itemContainer);
...
RestDraw.prototype.drawItem = function($itemContainer, item) {
	var $itemObject = $("<a />", {'href': '#', 'class': 'infinite-rest-draw-item list-group-item'}).appendTo($itemContainer);
