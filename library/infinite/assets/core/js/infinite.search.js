function InfiniteSearch (parent, options) {
   var self = this;
   this.parent = parent;
   var defaultOptions = {
      'remote': {
...
InfiniteSearch.prototype.searchItemResult = function(context) {
...
(function ($) { 
   $.fn.infiniteSearch = function (opts) {
         var $this = this;
         if ($this.infiniteSearchObject === undefined) {
            $this.infiniteSearchObject = new InfiniteSearch($this, opts);
         }

         return $this.infiniteSearchObject;
   };
}(jQuery));