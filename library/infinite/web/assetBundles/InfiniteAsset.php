...
class InfiniteAsset extends AssetBundle
{
    ...
    public $js = ['js/infinite.utils.js', 'js/infinite.core.js', 'js/infinite.bootstrap.js', 'js/infinite.ajax.instructions.js', 'js/infinite.ajax.js', 'js/infinite.smart.js'];
    public $depends = ['yii\bootstrap\BootstrapAsset', 'yii\bootstrap\BootstrapThemeAsset', 'yii\web\JqueryAsset', 'yii\jui\CoreAsset', 
