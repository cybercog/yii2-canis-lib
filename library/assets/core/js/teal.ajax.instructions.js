function TealInstructionHandler (instructions, ajaxEvent, ajaxOptions) {
...
TealInstructionHandler.prototype.staticPostTasks = ['status', 'trigger'];

TealInstructionHandler.prototype.handle = function() {
	var self = this;
	...
	if (self.instructions.taskSet) {
		jQuery.each(self.instructions.taskSet, function(index, task) {
			var instructor = new TealInstructionHandler(task, self.ajaxEvent, self.ajaxOptions);
			instructor.handle();
		});
	}
...
TealInstructionHandler.prototype.runHandler = function(task) {
...
TealInstructionHandler.prototype.handleStatus = function() {
	return true;
};

TealInstructionHandler.prototype.handleTrigger = function() {
	var self = this;
...
TealInstructionHandler.prototype.handleRemoveElement = function() {
	var self = this;
...
TealInstructionHandler.prototype.handleReplace = function() {
	var self = this;
...
TealInstructionHandler.prototype.handleRedirect = function() {
...
TealInstructionHandler.prototype.handleRefresh = function() {
	location.reload();
	return true;
};

TealInstructionHandler.prototype.handleMessage = function() {
...
TealInstructionHandler.prototype.handleDialog = function() {
	var self = this;
	if (!this.content) {
...
TealInstructionHandler.prototype.getTarget = function() {
};