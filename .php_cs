...
if (!isset($docBlockSettings['package'])) {
	$docBlockSettings['package'] = 'canis-core';
}
...
;
if ($isCanisCascade) {
    $finder->exclude('library' . DIRECTORY_SEPARATOR . 'canis' . DIRECTORY_SEPARATOR . 'cs');
}
...
$docBlockGenerator = new canis\cs\DocBlockGenerator();
